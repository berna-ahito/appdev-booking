    ...
    <div>
      ...
      <div className="middle-section">
        <div className="section-header">
          ...
          <button
            className="edit-button"
            onClick={isEditingPersonal ? handlePersonalInfo : () => setIsEditingPersonal(!isEditingPersonal)}
          >
          ...
          <div className="info-pair">
            ...
            {isEditingPersonal ? (
              <input
                ...
                onChange={(e) => setStudentDetails({ ...studentDetails, birth_date: e.target.value })}
              />
            ) : (
          ...
          <div className="info-pair">
            ...
            {isEditingPersonal ? (
              <input
                ...
                onChange={(e) => setStudentDetails({ ...studentDetails, contact_number: e.target.value })}
              />
            ) : (
